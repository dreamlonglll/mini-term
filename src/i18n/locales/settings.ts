export const settings = {
  zh: {
    ...
    terminal: {
      ...
      autoCopyDwellDesc: "拖选文本后按住鼠标不动超过该时长自动复制选中内容",
      longPaste: "长文本粘贴",
    ...
    themes: {
      ...
      importZip: "导入 zip",
      importZipDialogTitle: "选择主题包 zip 文件",
      deleteConfirm: "删除主题包「{name}」？其文件将从主题目录移除",
      openDir: "打开主题目录",
      refresh: "刷新",
  ...
  en: {
    ...
    terminal: {
      ...
      autoCopyDwellDesc: "After selecting text, holding the mouse still for this long copies the selection automatically",
    ...
    themes: {
      ...
      importZipDialogTitle: "Select a theme pack zip file",
      deleteConfirm: "Delete theme pack \"{name}\"? Its files will be removed from the themes folder",
