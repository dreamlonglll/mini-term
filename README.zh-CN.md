...
<p align="center">
  ...
  基于 Tauri v2 · 多项目 · 多标签 · 分屏布局 · AI 进程感知 · SSH 远程项目
</p>
...
| 测试覆盖 | 334 个 Rust 单元测试（pty / fs / config / hook / ssh） |
