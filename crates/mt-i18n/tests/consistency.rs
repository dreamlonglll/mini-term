...
///
/// —— 以下为 main 上与编排分支并行的增量（v1.2.5 ~ v1.2.11）——
...
///
/// 合入 main 后：862 + main 侧净增 17 = 879，命名空间仍为 33。
const EXPECTED_NAMESPACES: usize = 33;
const EXPECTED_ENTRIES_PER_LANG: usize = 879;
